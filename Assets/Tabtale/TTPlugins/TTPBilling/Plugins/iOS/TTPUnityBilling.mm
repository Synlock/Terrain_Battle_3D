...
extern "C" {
    ...
    void ttpValidateReceiptAndReport(const char * price, const char * currency, const char * productId)
    {
        ...
        if (billing != nil) {
            ...
            [billing validateReceiptAndReport:sPrice currency:sCurrency productID:sProductId completionHandler:^(BOOL verified) {
        ...
        if(billing != nil && message != NULL)
        {
            ...
            if(dic != nil){
                ...
                if(productId != nil && price != nil){
                    [billing reportPurchaseToConversion:[price floatValue] productId:productId consumable:[consumable boolValue]];
                }
            }
        }
    }
